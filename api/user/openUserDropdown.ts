...
function controlDropDown(item: any){ 
    ...
    if(item.dataset.target == itemId){ //if the data-target value of the HTML element sent is equal to the itemId we defined earlier
        ...
        if(item.selected == true){  //if this element is already selected,
            ...
            (document.querySelector("#User_toggle") as HTMLElement).style.backgroundColor = "transparent";
            ...
            (document.querySelector("#User_toggle") as HTMLElement).style.backgroundColor = "#c6c9d81a";
